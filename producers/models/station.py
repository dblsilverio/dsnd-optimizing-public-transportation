...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        topic_name = f"com.udacity.topics.stations.{station_name}"
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        station = self._build_station(direction, prev_direction, prev_station_id, train)
        self._produce(key, station)

        logger.debug(f"Arriving at station {self.name}: {train}. Direction is {direction}")

    def _build_station(self, direction, prev_direction, prev_station_id, train):
